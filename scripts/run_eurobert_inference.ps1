...
# Common arguments
$model_path = "T:\laupodteam\AIOS\Bram\language_modeling\Models\language_models\MultiClinAI\EuroBERT\multiclass_3ldense_20epochs_disease\fold_0"
...
foreach ($lang in $languages) {
    try {
        ...
        $output_prefix = "DISEASE_EuroBERT610_multiclass_${lang}_test_"
